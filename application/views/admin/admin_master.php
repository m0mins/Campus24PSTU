				...
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>super_admin"><i class="icon-home"></i><span class="hidden-tablet"> Dashbord</span></a></li>
                                                ...
                                                <li><a class="ajax-link" href="<?php echo base_url();?>super_admin/add_blog"><i class="icon-list-alt"></i><span class="hidden-tablet"> Add News</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>super_admin/manage_blog"><i class="icon-font"></i><span class="hidden-tablet"> Manage News</span></a></li>
